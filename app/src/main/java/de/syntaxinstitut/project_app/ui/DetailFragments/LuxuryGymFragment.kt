...
class LuxuryGymFragment : Fragment() {

    private lateinit var binding: FragmentLuxuryGymBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLuxuryGymBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        findNavController().navigate(LuxuryGymFragmentDirections.actionLuxuryGymFragmentToGymDifferenceFragment())
        }
    }
}